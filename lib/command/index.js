...
import {default: spinners} from 'cli-spinners'
import {default: ora} from 'ora'
...
import toPrompt from './flag-to-prompt'
import flagType from .js'./flag-type'
import Registry from '../registry'
import conf from .js'../conf'
import usage from '../usage'
import object from .js'../lang/object'
import typeOf from '../usage/type-of'
import exceptions from '../exceptions'
import colorize from .js'../colorize'
const stop_flags = new Set(['help', 'interactive', 'skip', 'color'])
const ARGV = 'argv'
const on_exp = /^on([A-z])/
import PROMPTS from './prompt-map.js'
